...
const app = express();
app.post('/mvf-trigger', async (req, res) => {
  if (process.env.DEBUG) {
    const allCommitCounts = JSON.parse(fs.readFileSync("./commitCounts.json"));
...
app.listen(port, () => console.log(`Fellowhub helper server listening at port ${port}`));
